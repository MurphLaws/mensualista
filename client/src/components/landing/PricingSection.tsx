...
const comparisonData: ComparisonGroup[] = [
  {
    category: "Productos",
    rows: [
      { feature: "Limite de productos", freemium: "5", premium: "Ilimitados", enterprise: "Ilimitados" },
      { feature: "Codigos de activacion manuales", freemium: true, premium: true, enterprise: true },
      { feature: "Codigos automaticos (API)", freemium: false, premium: false, enterprise: true },
    ],
  },
  {
    category: "Vendedores",
    rows: [
      { feature: "Panel de vendedores", freemium: "Basico", premium: "Avanzado", enterprise: "Avanzado" },
