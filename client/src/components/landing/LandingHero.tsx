...
import { ArrowRight, Building2, Users, TrendingUp, DollarSign, BarChart3, CheckCircle, Globe, ChevronDown } from "lucide-react";
              ...
              <div className="p-4 sm:p-6 space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[10px] sm:text-xs text-muted-foreground">Gestion de vendedores y ventas</p>
                  </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
                  {[
                    ...
                    { label: "Tasa conversion", value: "24%", icon: BarChart3 },
                  ].map((stat, i) => (
                    <motion.div
                      key={stat.label}
                      initial={{ opacity: 0, y: 10 }}
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  <div className="p-3 rounded-xl bg-card border border-border/50">
                    ...
                    <div className="space-y-1.5">
                      {["Tu logo y colores", "Panel de vendedores", "Gestion de comisiones", "Reportes en tiempo real"].map((f, i) => (
